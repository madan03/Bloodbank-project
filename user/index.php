...
<?php 
	...
	if(isset($_SESSION['user_id']) &&!empty($_SESSION['user_id'])){
		if(isset($_POST['date'])){
			...
			<strong>Are you to update  your record?</strong>
			...
			if(isset($_POST['userId'])){
				...
				$crntDate=date_format($crntDate, 'year-month-day');
								   ...
								   @$end   =date_create();
									...
									if($diffMonth >=3){
										...
										<span class="name">Congratulation!</span>
											<span> you already safe the life. You will donate the blood after three months . </span>
