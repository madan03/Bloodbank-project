			<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  					...
  					<div class="collapse navbar-collapse" id="collapsibleNavbar">
                            ...
                            <li class="nav-item">
      						...
      						<li class="nav-item">
        						<a href="../search.php" class="nav-link text-white"><i class="fa fa-search" ></i>Search</a>
      						</li>
     						 <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a  href="../donor.php" class="nav-link text-white" >Donors</a>
                  </li>
                   <li class="nav-item dropdown">
					 ...
					 <?php if(isset($_SESSION['name'])) echo $_SESSION['name'];?><!-- Donor Name -->
                       ...
                       <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a  href="index.php" class="dropdown-item"><i class="fa fa-user" aria-hidden="true"></i>Profile</a>

                       <a href="update.php" class="dropdown-item"><i class="fa fa-edit" aria-hidden="true"></i>
                      Update Profile</a>
